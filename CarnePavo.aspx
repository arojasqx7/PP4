<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="CarnePavo.aspx.vb" Inherits="CarnePavo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Carne Pavo </h1>
                        <p>Se caracterizan por tener grandes cantidades de vitamina B1 que juega juega un rol crucial en el metabolismo de los carbohidratos y proteínas para producir energía para el cuerpo. </p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6" style="padding:20px">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="buttons">
                                        <asp:TextBox ID="txtCantidad" width="50px" runat="server" Text="1"></asp:TextBox>
                                        <!--<a href="Carrito.aspx" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Añadir</a>-->
                                        <asp:Button class="btn btn-primary" ID="btnAdd" runat="server" Text="Añadir" />
                                    </p>
                                </div>
                                <!-- /.text -->
                            </div>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lt-gmonge.PROGRA4.dbo %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                            <SelectParameters>
                                <asp:QueryStringParameter DefaultValue="Carne Pavo" Name="TIPO" QueryStringField="Carne Pavo" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </div>
                    <!-- /.products -->
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="CarnePavo.aspx">&laquo;</a> </li>
                            <li><a href="CarnePavo.aspx">1</a> </li>
                        </ul>
                        </div>
                </div>
                <!-- /.col-md-9 -->

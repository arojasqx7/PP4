<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="CarneRes.aspx.vb" Inherits="CarneRes" %>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROGRA4ConnectionString_Andrey %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                            <SelectParameters>
                                <asp:QueryStringParameter DefaultValue="Carne Res" Name="TIPO" QueryStringField="Carne Res" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="CarneRes.aspx">&laquo;</a> </li>
                            <li><a href="CarneRes.aspx">1</a> </li>
                        </ul>
                        </div>
                </div>
                <!-- /.col-md-9 -->

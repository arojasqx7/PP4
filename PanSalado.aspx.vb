...
Partial Class PanSalado
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='PanSalado.aspx';</script>")
                End If
    ...
    Private Sub PanSalado_Load(sender As Object, e As EventArgs) Handles Me.Load

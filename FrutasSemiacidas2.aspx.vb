...
Partial Class FrutasSemiacidas2
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='FrutasSemiacidas2.aspx';</script>")
                End If
    ...
    Private Sub FrutasSemiacidas2_Load(sender As Object, e As EventArgs) Handles Me.Load

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Reposteria.aspx.vb" Inherits="Reposteria" %>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROGRA4ConnectionString_Andrey %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                            <SelectParameters>
                                <asp:QueryStringParameter DefaultValue="Reposteria" Name="TIPO" QueryStringField="Reposteria" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="Resposteria.aspx">&laquo; QueryStringField="Reposteria" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="Resposteria.aspx">&laquo;</a> </li>
                            <li><a href="Resposteria.aspx">1</a> </li>
                        </ul>
                        </div>
                </div>
                <!-- /.col-md-9 -->

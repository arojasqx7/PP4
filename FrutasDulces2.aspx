<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="FrutasDulces2.aspx.vb" Inherits="FrutasDulces2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Frutas Dulces</h1>
                        <p>Se caracterizan por el grupo más amplio y por no contener ácidos, son compatibles entre sí con excepción de la patilla. Ricas en Vitaminas A, C, E complejo B12 y B15.</p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lt-gmonge.PROGRA4.dbo %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Fruta Dulce1" Name="TIPO" QueryStringField="Fruta Dulce1" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="pages">
                        <ul class="pagination">
                            <li><a href="FrutasDulces1.aspx">&laquo;</a> </li>
                            <li><a href="FrutasDulces1.aspx">1</a> </li>
                            <li><a href="#">2</a> </li>
                        </ul>
                    </div>
                    </div>

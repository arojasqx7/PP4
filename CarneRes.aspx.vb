...
Partial Class CarneRes
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='CarneRes.aspx';</script>")
                End If
    ...
    Private Sub CarneRes_Load(sender As Object, e As EventArgs) Handles Me.Load

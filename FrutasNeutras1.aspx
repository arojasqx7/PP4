<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="FrutasNeutras1.aspx.vb" Inherits="FrutasNeutras1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Frutas Neutras</h1>
                        <p>Se caracterizan por ser las más ricas en proteínas (prótidos), vitaminas, sales minerales y oligoelementos.</p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROGRA4ConnectionString_Andrey %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Fruta Neutra" Name="TIPO" QueryStringField="Fruta Neutra" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="CarnePollo.aspx.vb" Inherits="CarnePollo" %>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lt-gmonge.PROGRA4.dbo %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                            <SelectParameters>
                                <asp:QueryStringParameter DefaultValue="Carne Pollo" Name="TIPO" QueryStringField="Carne Pollo" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="CarnePollo.aspx">&laquo;</a> </li>
                            <li><a href="CarnePollo.aspx">1</a> </li>
                        </ul>
                        </div>
                </div>
                <!-- /.col-md-9 -->

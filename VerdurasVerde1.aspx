<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="VerdurasVerde1.aspx.vb" Inherits="VerdurasVerde1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Verduras Verdes</h1>
                        <p>Aportan pocas calorías y tienen un gran valor alimentario por su riqueza en vitaminas (especialmente A , C , el complejo B, E y K ), minerales (en especial el calcio y el hierro) y fibra.</p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROGRA4ConnectionString_Andrey %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Verdura Verde" Name="TIPO" QueryStringField="Verdura Verde" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
                </div>
                    <!-- /.products -->

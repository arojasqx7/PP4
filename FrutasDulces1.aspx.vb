...
Partial Class FrutasDulces1
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='FrutasDulces1.aspx';</script>")
                End If
    ...
    Private Sub FrutasDulces1_Load(sender As Object, e As EventArgs) Handles Me.Load

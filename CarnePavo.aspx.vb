...
Partial Class CarnePavo
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='CarnePavo.aspx';</script>")
                End If
    ...
    Private Sub CarnePavo_Load(sender As Object, e As EventArgs) Handles Me.Load

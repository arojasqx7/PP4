...
Partial Class CarnePollo
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='CarnePollo.aspx';</script>")
                End If
    ...
    Private Sub CarnePollo_Load(sender As Object, e As EventArgs) Handles Me.Load

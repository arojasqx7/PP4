<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="VerdurasDeHoja1.aspx.vb" Inherits="VerdurasDeHoja1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Verduras De Hojas</h1>
                        <p>Las verduras de hoja suelen ser bajas en calorías y en grasa, altas en proteína por caloría, fibra alimentaria, hierro y calcio, y muy altas en fitoquímicos tales como la vitamina C, los carotenoides, la luteína y el ácido fólico, así como la vitamina K.</p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6" style="padding:20px">
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                                <img src="<%#DataBinder.Eval(Container.DataItem, "imagen")%>" alt="" class="img-responsive">
                                             </a>
                                        </div>
                                        <tr>
                                        <div class="back">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price"> <strong><asp:Literal ID="ltdescripcion" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "descripcion")%>'></asp:Literal><br /></strong> <asp:Literal ID="ltprecio" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "precio")%>'></asp:Literal> ROLLO</p>
                                    <div style="width:100%;">
                                        ...
                                        </div><!--<a href="Carrito.aspx" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Añadir</a> -->
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lt-gmonge.PROGRA4.dbo %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Verdura Hoja" Name="TIPO" QueryStringField="Verdura Hoja" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
                </div>
                    <!-- /.products -->

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="ActualizarProducto.aspx.vb" Inherits="ActualizarProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div id="content">
            <div class="container">
                ...
                <div class="col-md-6">
                    <div class="box">
                        <h3>Actualizar Informacion de un producto.</h3>
                        <p>
                            <table style="width: 37%;">
                                <tr>
                                    <td class="auto-style1">
                                <asp:TextBox ID="txt_busca_producto" class="form-control" placeholder="Ingrese codigo del producto..." runat="server" Height="34px" Width="320px" TextMode="Number"></asp:TextBox>
                                    </td>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txt_descripcion" class="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                        <asp:RegularExpressionValidator
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txt_codigo" class="form-control" runat="server" ReadOnly="True" TextMode="Number"></asp:TextBox>
                            </div>

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="FrutasAcidas2.aspx.vb" Inherits="FrutasAcidas2" %>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6" style="padding:20px">
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lt-gmonge.PROGRA4.dbo %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Fruta Acida2" Name="TIPO" QueryStringField="Fruta Acida2" Type="String" />
                             </SelectParameters>
                         </asp:SqlDataSource>
                </div>
                    <!-- /.products -->
                    <div class="pages">
                        ...
                        <ul class="pagination">
                            ...
                            <li><a href="FrutasAcidas.aspx">1</a> </li>
                            <li><a href="#">2</a> </li>
                        </ul>
                    </div>
                <!-- /.col-md-9 -->

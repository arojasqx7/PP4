<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="FrutasSemiacidas1.aspx.vb" Inherits="FrutasSemiacidas1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Frutas Semiácidas </h1>
                        <p>Se caracterizan por tener ácidos menos fuertes y más simples que las ácidas. Contienen elementos como el cianuro, son ricas en proteínas de alto valor biológico.</p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROGRA4ConnectionString_Andrey %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Fruta Semiacida" Name="TIPO" QueryStringField="Fruta Semiacida" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
                </div>
                    <!-- /.products -->
                    <div class="pages">
                            <p class="loadMore">
                            <a href="FrutasSemiacidas2.aspx" class="btn btn-primary btn-lg"><i class="fa fa-chevron-down"></i> Cargar más</a>
                        </p>

                        <ul class="pagination">
                            <li><a href="#">&laquo;</a> </li>
                            <li><a href="#">1</a> </li>
                            <li><a href="FrutasSemiacidas2.aspx">2</a> </li>
                        </ul>
                    </div>
                <!-- /.col-md-9 -->
            </div>

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="EliminarProducto.aspx.vb" Inherits="EliminarProducto" %>
                    ...
                    <div class="box">
                        ...
                        <p>
                            <table style="width: 37%;">
                                ...
                                <asp:TextBox ID="txt_busca_prod" class="form-control" placeholder="Ingrese codigo del producto..." runat="server" Height="34px" Width="320px" TextMode="Number"></asp:TextBox>
                                    </td>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txt_codigo" class="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <label for="name">Tipo</label>
                                <asp:TextBox ID="txt_tipo" class="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <label for="name">Precio </label>
                                <asp:TextBox ID="txt_precio" class="form-control" runat="server" TextMode="Number" ReadOnly="True"></asp:TextBox>
                            </div>
                            ...
                            <div class="text-center">
                                <asp:Button ID="btn_eliminar_prod" class="btn btn-primary" runat="server" Text="Eliminar" /> 
                            </div>

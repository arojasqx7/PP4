...
Partial Class VerdurasVerde1
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Redirect("VerdurasVerde1.aspx")
                    Response.Write("<script>alert('Producto agregado al carrito de compras.')</script>")
                    Response.Write("<script>window.location.href='VerdurasDeRaiz1.aspx';</script>")
                End If
    ...
    Private Sub VerdurasVerde1_Load(sender As Object, e As EventArgs) Handles Me.Load

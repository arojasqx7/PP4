<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="PanDulce.aspx.vb" Inherits="PanDulce" %>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROGRA4ConnectionString_Andrey %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                            <SelectParameters>
                                <asp:QueryStringParameter DefaultValue="Pan Dulce" Name="TIPO" QueryStringField="Pan Dulce" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="PanDulce.aspx">&laquo;                </div>
                                <!-- /.text -->
                            </div>
                            <!-- /.product -->
                        </div>
                    ...
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="PanDulce.aspx">&laquo;</a> </li>
                            <li><a href="PanDulce.aspx">1</a> </li>
                        </ul>
                        </div>
                </div>
                <!-- /.col-md-9 -->

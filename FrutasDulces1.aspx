<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="FrutasDulces1.aspx.vb" Inherits="FrutasDulces1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    ...
                    <div class="pages">
                            <p class="loadMore">
                            <a href="FrutasDulces2.aspx" class="btn btn-primary btn-lg"><i class="fa fa-chevron-down"></i> Cargar más</a>
                        </p>

                        <ul class="pagination">
                            <li><a href="#">&laquo;</a> </li>
                            <li><a href="#">1</a> </li>
                            <li><a href="FrutasDulces2.aspx">2</a> </li>
                        </ul>
                    </div>
                <!-- /.col-md-9 -->
            </div>

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="PanSalado.aspx.vb" Inherits="PanSalado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderHeadMenu" Runat="Server">
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        <h1>Pan Salado </h1>
                        <p>El Pan es uno de los principales componentes del grupo de alimentos que pertenecen a los cereales y sus derivados. Ahora bien, si lo incorporas en tu alimentación te aportara una gran cantidad de energía, propiedades nutritivas, hidratos de carbono y almidón </p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROGRA4ConnectionString_Andrey %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Fruta Salado" Name="TIPO" QueryStringField="Fruta Salado" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
                    </div>
                    <!-- /.products -->
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="PabSalado.aspx">&laquo;</a> </li>
                            <li><a href="PanSalado.aspx">1</a> </li>
                        </ul>
                        </div>
                </div>
                <!-- /.col-md-9 -->

...
Partial Class PanDulce
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='PanDulce.aspx';</script>")
                End If
    ...
    Private Sub PanDulce_Load(sender As Object, e As EventArgs) Handles Me.Load

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="EliminarEmpleado.aspx.vb" Inherits="EliminarEmpleado" %>
                    ...
                    <div class="box">
                        ...
                        <p>
                            ...
                            <div class="text-center">
                                <asp:Button ID="btn_eliminar_emp" class="btn btn-primary" runat="server" Text="Eliminar" /> 
                            </div>

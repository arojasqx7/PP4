...
Partial Class FrutasSemiacidas1
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='FrutasSemiacidas1.aspx';</script>")
                End If
    ...
    Private Sub FrutasSemiacidas1_Load(sender As Object, e As EventArgs) Handles Me.Load

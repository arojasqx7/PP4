<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="FrutasSemiacidas2.aspx.vb" Inherits="FrutasSemiacidas2" %>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row products">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lt-gmonge.PROGRA4.dbo %>" SelectCommand="SELECT * FROM [PRODUCTOS] WHERE ([TIPO] = @TIPO)">
                             <SelectParameters>
                                 <asp:QueryStringParameter DefaultValue="Fruta SemiAci2" Name="TIPO" QueryStringField="Fruta SemiAci2" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="pages">
                    <ul class="pagination">
                            <li><a href="FrutasSemiacidas1.aspx">&laquo;</a> </li>
                            <li><a href="FrutasSemiacidas1.aspx">1</a> </li>

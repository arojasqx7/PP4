...
Partial Class CarneCerdo
    Inherits System.Web.UI.Page

    Sub Items_ItemCommand(Sender As Object, e As RepeaterCommandEventArgs) Handles Repeater1.ItemCommand
        ...
        Else
            Try
                ...
                If e.CommandName = "AddToCart" Then
                    ...
                    Response.Write("<script>window.location.href='CarneCerdo.aspx';</script>")
                End If
    ...
    Private Sub CarneCerdo_Load(sender As Object, e As EventArgs) Handles Me.Load
